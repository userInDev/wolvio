...
export default function CTASection({ badge, headline, primaryCTA, secondaryCTA, footnote }: CTASectionProps) {
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <motion.h2
              ...
              className="text-3xl lg:text-4xl font-bold text-white leading-tight mb-8 max-w-3xl mx-auto"
            >
              {headline}
            </motion.h2>
            <motion.div
